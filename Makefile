...
DIR_OBJ		:= .build
DIR_BONUS	:= 
INCLUDE_ALL	:=-Iglobal -I$(DIR_SRC)/AI -I$(DIR_SRC)/Core -I$(DIR_SRC)/Interface -I$(DIR_SRC)/Parseur -I$(DIR_SRC)/Utils
...
include  src/AI/makefile.mk src/Core/makefile.mk src/Interface/makefile.mk src/Parseur/makefile.mk src/Utils/makefile.mk
-include $(DEPS)
...
OBJ_ALL		:= $(OBJ_AI) $(OBJ_CORE) $(OBJ_INTERFACE) $(OBJ_PARSEUR) $(OBJ_UTILS)
